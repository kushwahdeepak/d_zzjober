! function (a) {
    ...
    var b = {
        ...
        twitterFeed: function () {
            a.fn.tweet && a(".twitter-top-widget").length && a(".twitter-top-widget").tweet({
                modpath: "./js/twitter/",
                avatar_size: 32,
                count: 2,
                username: "eternalfriend38",
                loading_text: "searching twitter...",
                join_text: "",
                retweets: !1,
                template: '<div class="tweet_top clearfix">{avatar}<span>@{user}</span></div>{text}{time}'
            }), a.fn.tweet && a(".twitter-widget").length && a(".twitter-widget").tweet({
                modpath: "./js/twitter/",
                avatar_size: "",
                count: 2,
                query: "themeforest",
