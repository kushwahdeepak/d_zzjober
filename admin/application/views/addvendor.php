            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">  
                        <div class="col-md-6">
                            <h2 class="box-title floatalign_text_left"> Add Vendor Info </h2>
                        </div>
                        <div class="col-md-6 pull-right">
                            <a href="<?php echo base_url(); ?>index.php/admin/vendor" class="btn btn-default" style="float: right;"><i class="fa fa-reply"></i></a>
                        </div>
                    </div>

                    <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/admin/addvendorInfo" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-md-6">
                                    ...
                                    <div class="col-md-9">
                                        <input type="Password" class="form-control" title="Password do not match" id="confirmpassword" type="password" pattern="^\S{4,}$" onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Please enter the same Password as above' : '');" name="confirmpassword" placeholder="Confirm Password" required="required">  
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-md-6">
                                    <label class="col-sm-3 control-label asterisk"> Vendor Image </label>
                                    <div class="col-md-9">
...
<!-- 
 <script type="text/javascript">
    ...
    $("#addvendorInfos").submit(function (event) {
        ...
        $.ajax({
            url: "<?php  echo base_url(); ?>index.php/admin/addvendorInfo",
            type: 'POST',
            data: formData,
            async: false,
            cache: false,
